...
class Provider extends React.Component {
  ...
  render() {
    ...
    if (image) {
      providerContent = generateImage(image, alt, isAriaHidden, AVATAR_VARIANTS.PROVIDER, this.handleFallback);
    } else {
      providerContent = generateImagePlaceholder(alt, isAriaHidden, AVATAR_VARIANTS.PROVIDER);
    }
